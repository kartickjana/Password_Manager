...
class App extends Component {
  ...
  listenWebsite = each => {
    this.setState({website: each.target.value})
  }

  listenUsername = each => {
    this.setState({username: each.target.value})
  }

  listenPassword = each => {
    this.setState({password: each.target.value})
  }
  ...
  searchList = each => {
    this.setState({searchInput: each.target.value})
  }
